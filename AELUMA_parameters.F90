...
module aeluma_parameters
  ...
  real(kind = fp),    public, parameter :: sigma_dist = 100.0_fp, ttime_coef = 0.7_fp, sigma_traveltimediff = 60.0_fp, &
  &                                        sigma_dist2 = sigma_dist ** 2, sigma_traveltimediff2 = sigma_traveltimediff ** 2
