...
module gradiometry_parameters
  ...
  !integer,         public, parameter :: nsta_grid_max = 10, nsta_grid_min = 4
  ...
  !integer,         public, parameter :: naddstation_array = 1
  !integer,         public, parameter :: ngradient2 = 1500, ngradient4 = ngradient2 / 2
#ifdef ELLIPSE
  ...
  real(kind = fp), public, parameter :: grav_acc = 9.8_fp * 1.0e-3_fp !!in km/s^2
