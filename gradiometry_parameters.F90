...
module gradiometry_parameters
  ...
  real(kind = fp), public, parameter :: cutoff_dist = 7.0_fp
  ...
  integer,         public, parameter :: naddstation_array = 0
  integer,         public, parameter :: niteration_max = 8 
  integer,         public, parameter :: ngradient = 1000, ngradient2 = ngradient / 2, ngradient4 = ngradient2 / 2 + 50
